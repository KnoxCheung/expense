...
class ExpenseManager:
    ...
    def update_budget_limit(self, category, good_limit, normal_limit):
        self.budget.update_limit(category, good_limit, normal_limit)
        self.save_data()
    ...
    def get_monthly_calendar(self, year, month):
        ...
        for expense in self.expenses:
            ...
            if expense_date.year == year and expense_date.month == month:
                ...
                if day in month_expenses:
                    month_expenses[day].append(expense)
                else:
                    month_expenses[day] = [expense]

        return cal, month_expenses
...
if __name__ == "__main__":
    ...
    cal, month_expenses = manager.get_monthly_calendar(2023, 5)
    for week in cal:
        for day in week:
            if day == 0:
                print("   ", end=" ")
